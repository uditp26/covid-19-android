            ...
            call.enqueue(new Callback<Delete>() {
                ...
                public void onResponse(Call<Delete> call, Response<Delete> response) {
                    ...
                    if (!response.isSuccessful()){
                        ...
                        Toast.makeText(phoneET.getRootView().getContext(), "Invalid input", Toast.LENGTH_SHORT).show();
                        return;
                    }
                ...
                public void onFailure(Call<Delete> call, Throwable t) {
                    ...
                    Toast.makeText(phoneET.getRootView().getContext(), "Server Unavailable", Toast.LENGTH_SHORT).show();
                }
            });
            return true;
        }
